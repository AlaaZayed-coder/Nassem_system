      ...
      <div className="max-w-3xl w-full bg-white p-12 rounded-3xl shadow-xl border border-slate-100 text-center space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-8">
          ...
          >
            ...
            <span className="text-xl font-bold text-indigo-900 group-hover:text-white transition-colors">إدارة الإنتاج والتسعير</span>
          </Link>
          ...
          >
            ...
            <span className="text-xl font-bold text-orange-900 group-hover:text-white transition-colors">إدارة الآلات والصيانة</span>
          </Link>
        </div>
      </div>
    </main>
